...
// TODO: tutaj juz nie ma price_net , jest prices w wariantach jezykowych
      ...
      <div className='flex flex-col gap-4'>
        ...
        <div className='flex justify-between items-center'>
          <span className='text-default-400 text-small'>
            Łącznie {items.length} produktów
          </span>
        </div>
      </div>
    );
  ...
  return (
    <>
      ...
      >
        ...
        <TableBody
          emptyContent={'Brak danych do wyświetlenia'}
          items={sortedItems}
        >
          {(item) => (
          ...
          <>
            ...
            <ModalBody>
              <Tabs
                ...
                onSelectionChange={setActiveLanguage}
                className='mb-4'
              >
                <Tab
                  key='pl'
              ...
              <div className='border-1 p-4 rounded-lg mb-4'>
                <h3 className='font-semibold mb-2'>
                  Dane wielojęzyczne ({activeLanguage.toUpperCase()})
                </h3>
                <Input
                  label='Nazwa'
                  ...
                  onChange={(e) =>
                    handleMultilingualChange('name', e.target.value)
                  }
                  className='mb-2'
                />
                <Input
                  ...
                  onChange={(e) =>
                    handleMultilingualChange('short_name', e.target.value)
                  }
                  className='mb-2'
                />
                <Textarea
                  ...
                  onChange={(e) =>
                    handleMultilingualChange('description', e.target.value)
                  }
                  rows={3}
                />
              </div>
              ...
              <div className='border-1 p-4 rounded-lg mb-4'>
                ...
                <div className='flex gap-4 mb-2'>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange('product_group', e.target.value)
                    }
                  />
                </div>
                <div className='flex gap-4'>
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange('distance_code', e.target.value)
                    }
                  />
                  <Input
                    label='Kod (code)'
              ...
              <div className='border-1 p-4 rounded-lg mb-4'>
                ...
                <div className='flex gap-4 mb-2'>
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange('height_mm', e.target.value)
                    }
                  />
                  <Input
                    label='Wysokość (inch)'
                    ...
                    onChange={(e) =>
                      handleInputChange('height_inch', e.target.value)
                    }
                  />
                </div>
                <div className='flex gap-4'>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange('euro_palet', e.target.value)
                    }
                  />
                </div>
              </div>
              ...
              <div className='border-1 p-4 rounded-lg mb-4'>
                ...
                <div className='grid grid-cols-2 gap-4 mb-2'>
                  <Input
                    ...
                    step='0.01'
                    value={
                      formValues?.price?.PLN || formValues?.price_net || ''
                    }
                    onChange={(e) =>
                      handleInputChange('price_PLN', e.target.value)
                    }
                  />
                  <Input
                    label='Cena (EUR)'
                    ...
                    onChange={(e) =>
                      handleInputChange('price_EUR', e.target.value)
                    }
                  />
                  <Input
                    label='Cena (USD)'
                    ...
                    onChange={(e) =>
                      handleInputChange('price_USD', e.target.value)
                    }
                  />
                  <Input
                    label='Cena (GBP)'
                    ...
                    onChange={(e) =>
                      handleInputChange('price_GBP', e.target.value)
                    }
                  />
                </div>
              </div>
              ...
              <div className='flex justify-between text-sm text-gray-500'>
                ...
                <div>
                  ...
                  {formValues?.updated_at
                    ? new Date(formValues.updated_at).toLocaleString()
                    : 'N/A'}
                </div>
              </div>
            </ModalBody>
            <ModalFooter className='flex flex-row-reverse gap-4 items-center justify-between'>
              ...
              <div className='flex items-center justify-end gap-4'>
                <div className='error text-danger-600'>
                  {error && <p>{error}</p>}
                </div>
