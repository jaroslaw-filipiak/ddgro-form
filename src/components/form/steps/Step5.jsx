            ...
            <section>
                ...
                <Modal size='3xl' isDismissable={false} isOpen={isOpen} onOpenChange={onOpenChange}>
                    <ModalContent>
                        {onClose => (
                            <>
                                <ModalHeader className='flex flex-col gap-1'>Kolejny krok</ModalHeader>
                                <ModalBody>
                                    <p>
                                        W kolejnym kroku masz możliwość ręcznego dodania produktów z całego asortymentu ddgro. Jest to krok dodatkowy
                                        umożliwiający dodanie dodatkowej ilość produktów do zamówienia. Jeżeli nie chcesz dodawać dodatkowych produktów, kliknij
                                        przycisk Przechodze do podsumowania w prawym dolnym rogu.
                                    </p>
                                </ModalBody>
                                <ModalFooter>
                ...
                <div className='step--wrapper step-5 bg-[#f7f5f5] '>
                    ...
                    <div className='absolue inline-flex left-0 top-0  text-white font-bold text-base  flex-col gap-1 items-start justify-center'>
                        <p className='bg-main pt-3 pb-3 pl-8 pr-8'>Dodatkowe akcesoria do wsporników</p>
                    </div>
                    {/* content + padding */}
                    <div className='step--inner pt-20 pb-20 lg:pl-10 lg:pr-10 lg:w-10/12 mx-auto'>
                        ...
                        {!type && (
                            <div className='text-2xl lg:text-4xl text-center'>
                                Wybierz rodzaj nawierzchni tarasu (pkt 1), bez tych danych nie będziemy w stanie wyświelić listy akcesoriów
                            </div>
                        )}
                        ...
                        {type && (
                            <div className='series--info'>
                                <p className='text-2xl font-bold textaccesories-black text-opacity-70 pt-16 pb-9'>
                                    {loading ? 'Wczytuje dane...' : `Wybierz dodatkowe akcesoria, wybrany system: ${main_system}`}
                                </p>
