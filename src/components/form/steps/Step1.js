        ...
        <>
            <section>
                <div className='step--wrapper step-1 bg-[#f7f5f5] relative'>
                    {/* label absolute */}
                    <div className='absolue left-0 top-0 bg-main pt-3 pb-3 pl-8 pr-8 text-white font-bold text-base hidden lg:inline-flex'>{t('title')}</div>
                    {/* content + padding */}
                    <div className='step--inner pt-20 pb-20 lg:pl-10 lg:pr-10'>
                        <div className='p3 text-2xl lg:text-4xl font-bold text-center'>{t('question')}</div>
                        {/* items */}
                        <div className='flex items-center justify-center gap-10 mt-16'>
                            ...
                            >
                                <Image
                                    ...
                                    height={206}
                                />
                                <p className='text-black text-opacity-75 text-2xl font-bold mt-3'>{t('slabs')}</p>
                            </div>
                            <div
                            ...
                            >
                                <Image
                                    ...
                                    height={206}
                                />
                                <p className='text-black text-opacity-75 text-2xl font-bold mt-3'>{t('planks')}</p>
                            </div>
                        </div>
                        {/* mobile btn */}
                        <div className='w-full flex items-center justify-center mt-20 mb-16'>
                            ...
                            >
                                {t('nextButton')}
                                <Image className='ml-5' src='/assets/arrow-next.svg' alt={t('nextArrow')} width={42} height={42} />
                            </button>
                        </div>
