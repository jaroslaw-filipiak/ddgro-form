...
// import { Table, TableHeader, TableColumn, TableBody, TableRow, TableCell, getKeyValue } from '@heroui-org/react'
    ...
    */
    ...
    return (
        <div className='matrix pt-4 pb-4 border border-dashed mt-5'>
            <header>
                <button className='btn btn--main btn--rounded' onClick={handleCalculate}>
                    Calculate
                </button>
                <div>
