...
export default function FormHeader({ activeStep, setActiveStep, isFormAsideOpen, setFormAsideVisibility }) {
            ...
            <section className='lg:pb-32 h-12'>
                <div className='w-full columns1 md:columns-2 flex flex-col md:flex-row items-center justify-center gap-14'>
                    <div className='lg:w-2/12'>
                        <div className='cursor-pointer hover:opacity-80' onClick={() => setActiveStep(1)}>
                            <Image
